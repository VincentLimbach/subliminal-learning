...
SETUPS = [
    ("last_shared_init", "alpha=0.00: final init shared", "#9c9c9c"),
    ("lower_interp_0p25", "alpha=0.25", "#1f77b4"),
    ("lower_interp_0p5", "alpha=0.50", "#ff7f0e"),
    ("lower_interp_0p75", "alpha=0.75", "#2ca02c"),
    ("all_shared_init", "alpha=1.00: all init shared", "#6b4ea1"),
]
